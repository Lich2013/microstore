...
<div class="row">
    <div class="col-xs-12"><h3>专题阅览</h3></div>
</div>
<div class="row" style="text-align: center;">
    <div class="col-xs-12"><h2><?php echo ($data["title"]); ?></h2></div>
</div>
<div class="row" style="text-align: center;">
    <div class="col-xs-12"><img src="<?php echo ($data["pic"]); ?>" class="img-responsive"></div>
</div>
