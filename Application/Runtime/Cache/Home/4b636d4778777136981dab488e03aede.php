...
<div class="container-fluid">
    ...
    <div class="row header">
        <div class="col-xs-3 img-responsive" style="padding-top:0.5em;padding-bottom:0.5em;padding-right:0.3em;padding-left:inherit">
            <img src="/tuan/Public/images/logo.png" class="img-responsive">
        </div>
        <div class="col-xs-5 title">
				<span><div class="row">
                    <div class="col-xs-12">团团微店</div>
                </div>
				<div class="row">
                    <div class="col-xs-12" style="font-size: smaller;">重庆学子的创业家园</div>
                </div></span>
        </div>
        <div class="col-xs-4" style=" margin-top: 1%;">
            <div class="row" style="padding-top:0.5em;">
                <div class="col-xs-12">
                    <a href="<?php echo U('Join/index');;?>"><button class="btn btn-warning">申请入驻</button></a>
                </div>
            </div>
            <div class="row" style="padding-top:0.5em;">
                <div class="col-xs-12">
                    <a href="<?php echo U('Login/index');;?>"><button class="btn btn-info" style="background: #459BD6;">卖家登陆</button></a>
                </div>
            </div>
        </div>
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                        ...
                        <div class="item active">
                            ...
                            <img src="<?php echo ($topic[0]["pic"]); ?>" class="img-responsive">
                    ...
                    <?php if(is_array($topic)): $i = 0; $__LIST__ = array_slice($topic,1,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
                                ...
                                <img src="<?php echo ($vo["pic"]); ?>" class="img-responsive">
                                <div class="carousel-caption">
    ...
    <div class="row" style="padding-top:10px;">
        <form action="<?php echo U('View/view');;?>" method="post">
            <div class="col-xs-5" style="padding-right:inherit; text-align:center;">
            ...
            <div class="col-xs-5" style="margin-right: inherit; padding-left:0.1em;">
            ...
            <div class="col-xs-1"style="padding-left:inherit;padding-right:inherit;margin-left: 0.3em;">
