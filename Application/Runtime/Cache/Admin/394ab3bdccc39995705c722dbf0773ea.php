...
<div id="main-content">
    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
            ...
            <table>
                <form action="<?php echo U('Info/storeUpdate');?>" method="post">
                    <thead>
                    <tr>
                        <!--<th>-->
                    ...
                    <tbody>
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><input type="text" value="<?php echo ($vo["store_name"]); ?>" name="store_name[]" style="padding: 6px;border-radius: 4px;border: 1px solid #d5d5d5"/></td>
                                <td><input type="text" value="<?php echo ($vo["link"]); ?>" name="link[]" style="padding: 6px;border-radius: 4px;border: 1px solid #d5d5d5"/></td>
                                <td>
                                    <select name="goods_type_id[]" style="padding: 4px;border-radius: 4px;" >
                                        <?php if(is_array($goods_type)): $i = 0; $__LIST__ = $goods_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><option value="<?php echo ($goods["id"]); ?>" <?php $a = $vo['goods_id']==$goods['id']? 'selected="selected"':'';echo $a; ?> ><?php echo ($goods["type"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
                                <td>
                                    <select name="school_id[]" style="padding: 4px;border-radius: 4px;">
                                        <?php if(is_array($school)): $i = 0; $__LIST__ = $school;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$school_name): $mod = ($i % 2 );++$i;?><option value="<?php echo ($school_name["id"]); ?>" <?php $a = $vo['school_id']==$school_name['id']? 'selected="selected"':'';echo $a; ?> ><?php echo ($school_name["school_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
...
<script>
    $(".pass").live("click",function(){
        ...
        $.ajax({
            url: "<?php echo U('Info/storeUpdate');?>",

            type: 'post',

            data:{"store_id":store_id, "store_name":store_name, "link":link, "goods_type_id":goods_type, "school_id":school_id},
