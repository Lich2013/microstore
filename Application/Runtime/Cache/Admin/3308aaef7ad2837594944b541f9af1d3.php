...
<div id="main-content">
    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
            ...
            <table>
                <form action="<?php echo U('Index/relieve');?>" method="post">
                    <thead>
                    <tr>
                        <th>
                    ...
                    <tbody>
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <!-- Icons -->
                                    <a href="#" title="解除" class="pass" value="1"><img src="/tuan/Public/resources/images/icons/tick_circle.png" alt="通过" /></a>
                                </td>
