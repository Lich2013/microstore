...
<form action="<?php echo U('Topic/createTopic');?>" method="post" enctype="multipart/form-data">
            <div class="container" style="position:relative; float:left;left:400px;top: 200px">

                <div><input type="text" placeholder="标题" style="left: 300px" name="title"/></div>
                <div>封面图片(请上传jpg格式, 宽高比为2.6最佳):<input type="file" style="left: 300px" name="cover"/></div>
                <div class="hero-unit">
                    <div id="alerts"></div>
