...
<div id="main-content">
    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
            ...
            <table>
                <form action="<?php echo U('Topic/deleteTopic');?>" method="post">
                    <thead>
                    <tr>
                        <th>
                    ...
                    <tbody>
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <!-- Icons -->
                                    <a href="<?php echo U('Topic/edit');;?>?id=<?php echo ($vo["id"]); ?>" title="编辑" class="edit" value="2"><img src="/tuan/Public/resources/images/icons/pencil.png" alt="编辑" /></a>
                                    <a href="#" title="删除" class="delete" value="1"><img src="/tuan/Public/resources/images/icons/cross_circle.png" alt="删除" /></a>
                                </td>
...
<script>
    ...
    $(".delete").live("click",function(){
        ...
        $.ajax({
            url: "<?php echo U('Topic/deleteTopic');;?>",
